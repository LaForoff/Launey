...
import { ArrowBendUpLeft, ArrowsLeftRight, CaretRight, PencilSimple, Trash } from '@phosphor-icons/react'
import type { Space } from '../../types/space'
import './ContextMenu.css'

interface UrlContextMenuProps {
  x: number
  y: number
  spaces: Space[]
...
export function UrlContextMenu({
  x,
  y,
  spaces,
  activeSpaceId,
  ...
  return createPortal(
    ...
    >
      ...
      {submenuPosition
        ...
        : null}
      {onRemoveFromFolder ? (
        <button className="context-menu-item" type="button" onClick={onRemoveFromFolder}>
          <span className="context-menu-item-content">
            <span className="context-menu-icon">
