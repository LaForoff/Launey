  ...
  return (
    <div className="settings-section settings-section-about">
      ...
      <div className="settings-about-center">
        <img className="settings-about-app-icon" src={logoLauney} alt="Launey" />
        ...
        <p className="settings-about-description">
          Персональная стартовая страница для Safari в стиле Apple Launchpad, превращающая обычные
